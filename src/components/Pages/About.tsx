...
const About = () => {
  const Social = [
    ...
    { name: "Profile", icon: <FaUserCircle size={24} />, link: "https://mayuru-portfolio.vercel.app/" },
  ];
    ...
    <div className="bg-[#e6f2e6] text-[#333]">
      <section className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        >
          ...
          >
            Hello, I&apos;m Mayuru, a mountaineer, nature lover, and traveler.
            I love to travel to new places, experience different cultures, and
            capture the spirit of each adventure. I have published this site to
            bring you the beauty of this world through my travelogues, films,
            and images.
          </motion.p>
        </motion.div>
      </section>
