  ...
  return (
    <section className="relative w-full h-screen">
      ...
      <div className="absolute inset-0  bg-opacity-50 flex flex-col items-center justify-center text-center px-4">
        ...
        onClick={() => window.open("/vlog", "_blank")}
        className="mt-6 px-6 py-3 text-sm sm:text-base md:text-lg bg-white text-black rounded-lg hover:bg-gray-200 transition duration-300">
          Watch My Videos
        </button>
      </div>
    </section>
