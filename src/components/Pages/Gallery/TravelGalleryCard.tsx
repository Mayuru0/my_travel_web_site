...
const TravelGalleryCard: React.FC<TravelGalleryCardProps> = ({ destination }) => (
  <div className="flex items-center justify-center w-full">
    <div className="w-full">
      <Link href={`/gallery/${destination.id}`} className="block group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl rounded-lg">
